...
function getGeoJSON(){
	...
	$.getJSON(geojsonPath,function(data){
		...
		mapGeoJSON('pop_est'/*, whatever number to call*/) // add a field to be used
	})
}
...
function mapGeoJSON(field /*, num_class, etc....*/){
	...
	brew.setNumClasses(8 /*num_class*/); //how many groups of colors there are 
	brew.setColorCode('YlOrRd');
	brew.classify('quantiles'); //how the color groups are classiflied 
...
function getColor(d) {
	return d > 1000000000 ? '#800026' : // syntax: if value of d is greater than xxxxx, then make it xxx color.
		   d > 500000000  ? '#BD0026' :
		   d > 200000000  ? '#E31A1C' :
		   d > 100000000  ? '#FC4E2A' :
		   d > 50000000   ? '#FD8D3C' :
